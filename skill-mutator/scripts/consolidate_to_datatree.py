...
Usage:
    python scripts/consolidate_to_datatree.py \\
        --result-root e:/eval/tmp/claude_smoke_result \\
        --oracle claude-opus-4-7 \\
        --data-root E:/eval/Skillmutator-data
"""
...
def main() -> None:
    ...
    ap.add_argument("--data-root", default="E:/eval/Skillmutator-data",
                    help="Canonical tree root (default: E:/eval/Skillmutator-data).")
