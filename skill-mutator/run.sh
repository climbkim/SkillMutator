...
: "${OPENAI_API_KEY:?Set OPENAI_API_KEY before running (oracle + LLM scanner + judge all call OpenAI)}"
...
echo "   analysis/paper_floats/outputs/   (table3_refusal*, table4_cross_scanner*, table5_select*, figure4_ier*)"
