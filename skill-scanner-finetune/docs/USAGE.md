...
Expected drop on Qwen/Llama: ≈ −13 pp / −8 pp respectively (paper §RQ3 Finding 2). Mistral and Gemma actually score *higher* without prefill due to chat-template incompatibilities; pick the variant that matches your base model.
